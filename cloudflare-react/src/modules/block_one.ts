...
export const initialStateRoadItems: BudgetItem[] = [
  {
    ...
    value: null,
    tooltip: "Загальний обсяг бюджетних коштів на дороги державного значення"
  },
  {
    id: "Qпп",
    ...
    value: null,
    tooltip: "Кошти на пункти пропуску через державний кордон"
  },
  {
    id: "Qміжн",
    ...
    value: null,
    tooltip: "Кошти для фінансування проведення конкурсів і підготовки договорів"
  },
  {
    id: "QІАС",
    ...
    value: null,
    tooltip: "Кошти на інформаційно-аналітичну систему дорожнього господарства"
  },
  {
    id: "Qн",
  ...
  },
  {
    ...
    value: null,
    tooltip: "Кошти на виплати приватному партнеру/концесіонеру"
  },
];
