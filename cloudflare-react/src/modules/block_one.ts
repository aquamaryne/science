...
export const initialStateRoadItems: BudgetItem[] = [
  {
    id: "Qдз",
    name: "Обсяг бюджетного фінансування автомобільних доріг державного значення (будівництво, реконструкція, капітальний та поточний ремонти, утримання).",
    value: null,
  ...
  {
    id: "Qпп",
    name: "Обсяг бюджетного фінансування пунктів пропуску через державний кордон для автомобільного сполучення (розвиток, будівництво, ремонт, облаштування, модернізація, утримання).",
    value: null,
  ...
  {
    id: "Qміжн",
    name: "Обсяг бюджетного фінансування проведення конкурсів та підготовки договорів щодо робіт з автомобільними дорогами за рахунок коштів міжнародних організацій, кредиторів та інвесторів, включаючи співфінансування та контроль виконання.",
    value: null,
  ...
  {
    id: "QІАС",
    name: "Обсяг бюджетного фінансування створення та функціонування інформаційно-аналітичної системи дорожнього господарства, включаючи утримання відповідних бюджетних установ.",
    value: null,
    tooltip: "Обсяг бюджетних коштів, що спрямовується на фінансове забезпечення заходів зі створення та функціонування інформаційно-аналітичної системи дорожнього господарства, у тому числі утримання відповідних бюджетних установ, що забезпечують її функціонування"
  },
  {
    id: "Qн",
  ...
  {
    id: "QДПП",
    name: "Обсяг бюджетного фінансування виплат приватному партнеру/концесіонеру за експлуатаційну готовність автомобільних доріг державного значення та інших виплат згідно з договорами державно-приватного партнерства.",
    value: null,
...
export const initialLocalRoadItems: BudgetItem[] = [
  ...
  {
    id: "Qкред",
    name: "Обсяг бюджетного фінансування погашення та обслуговування місцевого боргу за запозиченнями для виконання дорожніх робіт на автомобільних дорогах місцевого значення та комунальної власності.",
    value: null,
  ...
  {
    id: "QДПП2",
    name: "Обсяг бюджетного фінансування виплат приватному партнеру/концесіонеру за експлуатаційну готовність автомобільних доріг місцевого значення та інших виплат згідно з договорами державно-приватного партнерства.",
    value: null,
