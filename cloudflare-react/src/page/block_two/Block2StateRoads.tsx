...
const Block2StateRoads: React.FC<Block2StateRoadsProps> = ({ onCalculated }) => {
              ...
              <Alert className="bg-green-50 border-green-400">
                ...
                <AlertDescription className="text-green-800">
                  ...
                  <div className="text-sm mt-1">
                    Нормативи для державних доріг розраховано. Тепер ви можете перейти до наступного етапу.
                  </div>
                </AlertDescription>
              </Alert>
